...
npm is also supported for consumer installs (`npm ci`, `npm test`). The test suite uses vitest. TypeScript is strict, Node-only, and uses ESM imports with `.js` suffixes.
